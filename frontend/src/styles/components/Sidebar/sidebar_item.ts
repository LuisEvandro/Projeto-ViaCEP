...
export const ContainerBoxSidebarItem = styled(Box)<ContainerBoxSidebarItemrops>`
  ...
  background-color: ${props => props.active ? props => props.theme.colors.primary : 'transparent'};
  box-shadow: ${props => props.active ? props => '0 2px 6px '+props.theme.colors.primary : 'none'};
  padding: 10px 15px;
  border-radius: 15px;
  ...
  .content_item{
    ...
    .item_icon{
      display: flex;
      align-items: center;
      margin-right: ${props => props.open ? '10px' : '0px'};
